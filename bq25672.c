...
{
    if (HAL_I2C_Mem_Write(hi2c, BQ25672_I2C_ADDR, reg, I2C_MEMADD_SIZE_8BIT, &val, 1, HAL_MAX_DELAY) != HAL_OK)
...
{
    if (HAL_I2C_Mem_Read(hi2c, BQ25672_I2C_ADDR, reg, I2C_MEMADD_SIZE_8BIT, val, 1, HAL_MAX_DELAY) != HAL_OK)
        return BQ25672_COMM_FAIL;
    return BQ25672_OK;
}
